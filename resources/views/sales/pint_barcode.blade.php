        ...
        if(paper_size != "0") {
            ...
            /*$.each(qty, function(index){
                ...
                while(i < qty[index]){
                    if(i % 2 == 0)
                        htmltext +='<tr>';
                    htmltext +='<td style="width:164px;hei8ht:88%;padding-top:7px;vertical-align:middle;text-align:center">';
                    htmltext += product_name[index] + '<br>';
                    htmltext += '<img style="max-width:1508x;" src="data:image/png;base64,'+barcode_image[index]+'" alt="barcode" /><br>';
            ...
            $.each(qty, function(index){
                ...
                // console.log(qty+' '+index+' '+'a7a');
                // console.log(qty[index]);
                i = 0;
                while(i < qty[index]) {
                    // if(i % 2 == 0)
                        htmltext +='<tr style="padding-top:0;margin-top:0">';
                    // 36mm
                    if(paper_size == 36)
                        htmltext +='<td style="text-align:center;font-size:32px">';
                    //24mm
                    ...
                    if(paper_size == 18){
                        htmltext += '<img style="height:70px;max-width:190px;" src="data:image/png;base64,'+barcode_image[index]+'" alt="barcode" /><br>';
                    }else{
                        htmltext += '<img style="height:70px;max-width:190px;" src="data:image/png;base64,'+barcode_image[index]+'" alt="barcode" /><br>';
                    }

                    //(( transalation of image code ))
